...
def build_MLP(input_var, output_var, time_plot, data_index, hidden_layers_info, opt, test_parameters, name_model, data_type, show_progress, Trial_RMSE ):
    ...
    if RMSE < Trial_RMSE:
        ...
        make_plot(path, 'Model_2_Inflow', time_scale, 'Date', 'Inflow ($m^3/s$)', Test_out[:,0], 'Real Data', Test_out_pred[:,0], 'Estimation Total Inflow')
        ...
        if data_index[1]==data_index[0]:
            ...
            File_name = path + "model2_" + name_model +".h5"
