...
name_file = 'Reomve_one_type1.p'
R_mean, MAE_mean, RMSE_mean, R_std, MAE_std, RMSE_std, N_error_vec_t, Data = feature_selections_results(name_file)

X_1_ticks =['Control','Days', 'Temperature','Precipitation','Humidity','Irradiation','Pressure','Station 544','Station 546']
Name = 'Remove a Type'
path = 'C:/Users/Paulo_Rocha/Desktop/Tese/Tese_code/Model_1/Feature_Selection/Results/Plots'

make_plot_point( path, Name, R_mean, MAE_mean, RMSE_mean, R_std, MAE_std, RMSE_std, X_1_ticks, 'Remove_type' )
