...
def order_vars( Dam, N_holiday, G_holiday, W_n, W_b, W_c, Eco_outflow, data_type ):
    ...
    Max = [ 365, 170,   3, 230, 230, 50, 180, 90, 7]
...
data_type = [2,1,0,1,0,1,2,1]

input_value, output_value, _, input_value_sec, output_value_sec = order_vars( Brandariz, N_holiday, G_holiday, W_n, W_b, W_c, Eco_outflow, data_type )
...
model_3_data  = {'u': input_var,
                 'y':output_var,
                 'u_sec': input_var_sec,
                 'y_sec':output_var_sec,}

savemat("model_3_data_OG.mat", model_3_data)